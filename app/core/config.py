...
class Settings(BaseSettings):
    ...
    CORS_ORIGINS: str = Field(
        default="http://localhost:8000,http://127.0.0.1:8000,http://localhost:5173,http://127.0.0.1:5173,http://localhost:4173,http://127.0.0.1:4173",
        env="CORS_ORIGINS"
    )
    ...
    TINYFISH_API_KEY: Optional[str] = Field(None, env="TINYFISH_API_KEY")
    TINYFISH_BASE_URL: str = Field(default="https://api.tinyfish.io/v1", env="TINYFISH_BASE_URL")
